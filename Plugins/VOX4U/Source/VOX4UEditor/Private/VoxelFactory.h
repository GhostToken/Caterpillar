...
private:
	...
	UStaticMesh* CreateStaticMesh(UObject* InParent, FName InName, EObjectFlags Flags, FVox* Vox) const;

	USkeletalMesh* CreateSkeletalMesh(UObject* InParent, FName InName, EObjectFlags Flags, FVox* Vox) const;

	UDestructibleMesh* CreateDestructibleMesh(UObject* InParent, FName InName, EObjectFlags Flags, FVox* Vox) const;

	UVoxel* CreateVoxel(UObject* InParent, FName InName, EObjectFlags Flags, FVox* Vox) const;

	UStaticMesh* BuildStaticMesh(UStaticMesh* OutStaticMesh, FRawMesh& RawMesh) const;

	UMaterialInterface* CreateMaterial(UObject* InParent, FName &InName, EObjectFlags Flags, FVox* Vox) const;
